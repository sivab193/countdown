...
*   **📱 Progressive Web App (PWA)**: Install CtDn directly to your iOS or Android home screen for quick offline-ready access.
...
*   `NEXT_PUBLIC_SITE_TITLE` (optional — defaults to "CtDn")
